...
export default function ContactCta({ variant = "contactCta" }: { variant?: "contactCta" | "contactCtaEcriture" }) {
  const t = useTranslations("Footer");

  return (
    <footer className="bg-brand-navy">
      <div className="container mx-auto flex flex-col items-center gap-4 p-8 text-center">
        <p className="text-brand-blue-light text-xl font-semibold">{t(variant)}</p>
        <button
          type="button"
